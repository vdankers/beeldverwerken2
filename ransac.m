...
function [bestModel, bestInliers] = ransac(xy, uv)
  ...
  k = 200;  % maximum number of iterations allowed in the algorithm
  ...
  while iterations < k 
    ...
    % For all points that were not consensus, check how well the current
